...
def size(filename):
    filename = "level_levels/" + filename
...
player_image = pg.transform.scale(pg.image.load('level_assets/player.gif').convert_alpha(), (tile_width, tile_height))
...
tile_images = {
    'wall': pg.transform.scale(pg.image.load('level_assets/box.png'), (tile_width, tile_height)),
    'empty': pg.transform.scale(pg.image.load('level_assets/floor.png'), (tile_width, tile_height))
}
player, level_x, level_y = generate_level(load_level('level_levels/map.txt'))
